...
# preview runs the medical router, dated evidence layer and multi-agent safety review.
...
print('Vercel dist built with Medical LLM Stack V3 + Recent Evidence RAG V1 + Multi-Agent Review V1')
