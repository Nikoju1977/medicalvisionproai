...
# quantitative post-detection pass, verified DICOM physical calibration and a
# separate curated web-reference explorer for research context.
...
print('Vercel dist built with Medical LLM Stack V3 + Evidence RAG V1 + Multi-Agent Review V1 + Quantitative Pass V1 + DICOM Calibration V1 + curated web knowledge explorer')
